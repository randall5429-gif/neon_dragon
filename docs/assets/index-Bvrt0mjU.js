...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Vs(e,t,n){let r=new Float32Array(Ds),i=new U(0,1,0);return new io({name:`SphericalGaussianBlur`,defines:{n:Ds,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ws(),fragmentShader:`
	...
	`}var Gs=class extends qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new wi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},ju=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},Mu=new Ko(-1,1,1,-1,0,1),Nu=new class extends Dr{constructor(){super(),this.setAttribute(`position`,new hr([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new hr([0,2,0,0,2,0],2))}},Pu=class{constructor(e){this._mesh=new q(Nu,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,Mu)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},Fu=class extends ju{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof io?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=to.clone(e.uniforms),this.material=new io({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new Pu(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Iu=class extends ju{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},Lu=class extends ju{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},Ru=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new H);this._width=n.width,this._height=n.height,t=new qt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:g}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Fu(Au),this.copyPass.material.blending=0,this.timer=new Zo}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}Iu!==void 0&&(r instanceof Iu?n=!0:r instanceof Lu&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new H);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},zu=class extends ju{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new K}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},Bu={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new K(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Vu.BlurDirectionX=new H(1,0),Vu.BlurDirectionY=new H(0,1);var Hu=document.querySelector(`#scene`),Uu=document.querySelector(`#referenceDragon`),Wu=document.querySelector(`#motionToggle`),Gu=document.querySelector(`#resetView`),Ku=document.querySelector(`#glowRange`),qu=`http://www.w3.org/2000/svg`,Ju=e=>`./${e.replace(/^\/+/,``)}`,X={night:new K(`#050101`),ember:new K(`#c73a16`),ruby:new K(`#7c080b`),blood:new K(`#310405`),fire:new K(`#ff7626`),gold:new K(`#f6bf55`),paleGold:new K(`#ffe9a8`),smoke:new K(`#9b6844`)},Yu=new ku({canvas:Hu,antialias:!0,alpha:!1,powerPreference:`high-performance`});Yu.outputColorSpace=Le,Yu.toneMapping=4,Yu.toneMappingExposure=.98;var Xu=new Nn;Xu.background=new K(`#000000`),Xu.fog=null;var Zu=new Ko(-10,10,6,-6,.1,80);Zu.position.set(0,0,16),Zu.lookAt(0,0,0);var Qu=new Ru(Yu);Qu.addPass(new zu(Xu,Zu));var $u=new Vu(new H(1,1),.62,.42,.18);Qu.addPass($u);var ed=new ds,td=new H(.45,.08),nd=new U(2.7,.45,.6),rd=nd.clone(),id=new U,ad=new U,od=new K,Z={paused:!1,glow:Number(Ku?.value??1.15),elapsed:0,viewWidth:20,viewHeight:12,segmentSpacing:.36,bodyRadius:.22,pointerActive:!1,lastPointerAt:0,dragonLoaded:!1,lanternLoaded:!1},sd={ready:!1,screen:null,elems:[],phase:Math.random()*Math.PI*2,orbit:0},cd=new Tn,ld=new Tn,ud=new Tn;Xu.add(ld,cd,ud),ld.visible=!1,cd.visible=!1;var dd=rf();cd.add(dd.group);var fd=of();fd.forEach(e=>ld.add(e.group));var pd=uf();pd.forEach(e=>ld.add(e.group));var md=df();ld.add(md.points);var Q=Ud(),$=Wd(Q);ud.add($.group);var hd=af();cd.add(hd.points);var gd=[],_d=.7;Md(Z.glow),Nd(),jd(),Pd(),Fd(),vd(),window.addEventListener(`resize`,Nd),window.addEventListener(`pointermove`,yd,{passive:!0}),window.addEventListener(`pointerdown`,yd,{passive:!0}),window.addEventListener(`pointerleave`,()=>{Z.pointerActive=!1}),Wu.addEventListener(`click`,()=>{Z.paused=!Z.paused,Wu.setAttribute(`aria-label`,Z.paused?`Resume motion`:`Pause motion`),Wu.innerHTML=Z.paused?`<span class="play-icon" aria-hidden="true"></span>`:`<span class="pause-icon" aria-hidden="true"><span></span><span></span></span>`}),Gu.addEventListener(`click`,jd),Ku?.addEventListener(`input`,e=>Md(Number(e.target.value)));function vd(){requestAnimationFrame(vd);let e=Math.min(ed.getDelta(),.033);Z.paused||(Z.elapsed+=e,bd(),xd(e),cd.visible&&Dd(e),ld.visible&&(Od(e),kd(e))),Qu.render()}function yd(e){e.target.closest?.(`.controls`)||(td.x=e.clientX/window.innerWidth,td.y=e.clientY/window.innerHeight,Z.pointerActive=!0,Z.lastPointerAt=performance.now())}function bd(){let e=performance.now()-Z.lastPointerAt;if(!Z.pointerActive||e>4200){let e=Z.elapsed;td.x=.58+Math.sin(e*.43)*.22+Math.sin(e*.91)*.06,td.y=.44+Math.cos(e*.37)*.17+Math.sin(e*.83)*.05}let t=window.innerWidth<650?.72:.82,n=Dt.clamp(td.x,.1,.92),r=Dt.clamp(td.y,.12,t);rd.set((n-.5)*Z.viewWidth,(.5-r)*Z.viewHeight,.62)}function xd(e){if(nd.lerp(rd,1-.012**e),sd.ready){Hd(e);return}Sd(e),Cd(e),Ed(e)}function Sd(e){let t=Q.bones[0],n=Z.segmentSpacing*1.42,r=id.subVectors(nd,t.position),i=Math.max(r.length(),.001),a=ad.copy(nd).addScaledVector(r.normalize(),-n),o=1-.015**e;t.previous.copy(t.position),t.position.lerp(a,o),t.position.x=Dt.clamp(t.position.x,-Z.viewWidth*.44,Z.viewWidth*.44),t.position.y=Dt.clamp(t.position.y,-Z.viewHeight*.32,Z.viewHeight*.28),t.velocity.subVectors(t.position,t.previous).multiplyScalar(1/Math.max(e,.001));let s=Dt.clamp(i*.028,.015,.075);for(let t=0;t<2;t+=1)for(let n=1;n<Q.bones.length;n+=1){let r=Q.bones[n-1],i=Q.bones[n],a=Z.segmentSpacing*(n<3?.84:n>Q.bones.length-4?.92:1),o=id.subVectors(i.position,r.position);i.previous.copy(i.position),o.lengthSq()<1e-4&&o.set(-1,0,0),o.normalize();let s=ad.copy(r.position).addScaledVector(o,a),c=.54-Math.min(n*.007,.18);i.position.lerp(s,t===0?c:.82),i.velocity.subVectors(i.position,i.previous).multiplyScalar(1/Math.max(e,.001))}for(let e=1;e<4;e+=1){let t=Q.bones[e-1].position,n=Q.bones[e].position,r=Q.bones[e+1].position,i=.16-e*.025;id.copy(t).lerp(r,.5),n.lerp(id,i)}for(let e=0;e<Q.bones.length;e+=1){let t=Q.bones[e],n=Q.renderBones[e],r=Q.bones[Math.max(0,e-1)],i=Q.bones[Math.min(Q.bones.length-1,e+1)],a=id.subVectors(r.position,i.position);a.lengthSq()<1e-4&&a.set(1,0,0),a.normalize();let o=ad.set(-a.y,a.x,0),c=e/(Q.bones.length-1),l=Dt.smoothstep(c,.02,.28),u=Math.sin(Z.elapsed*2.35+e*.58)*Z.segmentSpacing*(.09+c*.11+s)*l*(1+c*.28);n.copy(t.position).addScaledVector(o,u),n.z=.2-e*.004}}function Cd(e){$.bodyMaterials.forEach((e,t)=>{e.uniforms.uTime.value=Z.elapsed,e.uniforms.uGlow.value=Z.glow,e.uniforms.uPhase.value=t*.37}),$.textureMaterials.forEach(e=>{e.uniforms.uTime.value=Z.elapsed,e.uniforms.uGlow.value=Z.glow}),wd(),$.bodySegments.forEach((e,t)=>{let n=Q.renderBones[t],r=Q.renderBones[t+1],i=t/Math.max(1,$.bodySegments.length-1),a=Z.bodyRadius*(1.06-i*.4);ff(e,n,r,{width:1.82+i*.18,height:a,z:.22-t*.004})}),$.bellySegments.forEach((e,t)=>{let n=t+2,r=Q.renderBones[n],i=Q.renderBones[Math.min(n+1,Q.renderBones.length-1)],a=id.subVectors(r,i).normalize(),o=ad.set(a.y,-a.x,0),s=id.copy(r).lerp(i,.48).addScaledVector(o,Z.bodyRadius*.34);e.position.copy(s),e.position.z=.34,e.rotation.z=Math.atan2(r.y-i.y,r.x-i.x);let c=1+Math.sin(Z.elapsed*3.2+t*.8)*.08;e.scale.set(Z.bodyRadius*.38*c,Z.bodyRadius*.16,1),e.material.opacity=.18+Z.glow*.08}),$.spines.forEach((e,t)=>{let n=e.bone,r=Q.renderBones[n],i=Q.renderBones[Math.max(0,n-1)],a=Q.renderBones[Math.min(Q.renderBones.length-1,n+1)],o=id.subVectors(i,a).normalize(),s=ad.set(-o.y,o.x,0),c=n/Math.max(1,Q.bones.length-1),l=Z.bodyRadius*(1-c*.36);e.mesh.position.copy(r).addScaledVector(s,l*(.72+e.lift)),e.mesh.position.z=.48,e.mesh.rotation.z=Math.atan2(s.y,s.x)-Math.PI/2+Math.sin(Z.elapsed*e.speed+e.phase)*e.swing,e.mesh.scale.set(l*e.width,l*e.height,1),e.mesh.material.opacity=e.opacity*(.82+Z.glow*.32)}),$.claws.forEach(e=>{let t=Q.renderBones[e.bone],n=Q.renderBones[Math.max(0,e.bone-1)],r=Q.renderBones[Math.min(Q.renderBones.length-1,e.bone+1)],i=id.subVectors(n,r).normalize(),a=ad.set(i.y,-i.x,0);a.y>0&&a.multiplyScalar(-1),e.group.position.copy(t).addScaledVector(a,Z.bodyRadius*e.drop),e.group.position.z=e.z,e.group.rotation.z=Math.atan2(i.y,i.x)*.28+e.side*.08+Math.sin(Z.elapsed*e.speed+e.phase)*.04,e.group.scale.setScalar(Z.segmentSpacing*e.scale)});let t=Q.renderBones[0],n=Q.renderBones[2],r=Math.atan2(t.y-n.y,t.x-n.x);$.head.position.copy(t),$.head.position.z=.76,$.head.rotation.z=r,$.head.scale.setScalar(Z.segmentSpacing*2.25);let i=Q.renderBones[Q.renderBones.length-1],a=Q.renderBones[Q.renderBones.length-3],o=Math.atan2(i.y-a.y,i.x-a.x);$.tail.position.copy(i),$.tail.position.z=.6,$.tail.rotation.z=o+Math.sin(Z.elapsed*3.6)*.22,$.tail.scale.setScalar(Z.segmentSpacing*2.28),$.tailDetails.forEach((e,t)=>{e.rotation.z=e.baseRotation+Math.sin(Z.elapsed*e.speed+t)*e.swing,e.material.opacity=e.baseOpacity*(.82+Z.glow*.28)}),$.shadow.position.copy(pf()),$.shadow.position.y-=Z.bodyRadius*1.8,$.shadow.position.z=-.35,$.shadow.scale.set(Z.segmentSpacing*14,Z.segmentSpacing*1.35,1),$.shadow.material.opacity=.16+Math.sin(Z.elapsed*1.5)*.025,Td(r)}function wd(){let e=$.bodyRibbon.geometry.attributes.position.array,t=Q.renderBones.length;$.bodyRibbon.material.uniforms.uTime.value=Z.elapsed,$.bodyRibbon.material.uniforms.uGlow.value=Z.glow;for(let n=0;n<t;n+=1){let r=Q.renderBones[n],i=Q.renderBones[Math.max(0,n-1)],a=Q.renderBones[Math.min(t-1,n+1)],o=id.subVectors(i,a);o.lengthSq()<1e-4&&o.set(1,0,0),o.normalize();let s=ad.set(-o.y,o.x,0),c=n/Math.max(1,t-1),l=Dt.lerp(1.16,.52,c**1.28),u=1+(1-Dt.smoothstep(c,.02,.22))*.1,d=Z.bodyRadius*l*.82*u,f=Z.bodyRadius*l*(1.02-c*.12)*u,p=n*6;e[p]=r.x+s.x*d,e[p+1]=r.y+s.y*d,e[p+2]=.14-n*.004,e[p+3]=r.x-s.x*f,e[p+4]=r.y-s.y*f,e[p+5]=.14-n*.004}$.bodyRibbon.geometry.attributes.position.needsUpdate=!0}function Td(e){$.headDetails.forEach((e,t)=>{e.material.opacity=e.baseOpacity*(.86+Z.glow*.14),e.rotation.z=e.baseRotation+Math.sin(Z.elapsed*e.speed+t*.6)*e.swing}),$.whiskers.forEach((e,t)=>{let n=e.line.geometry.attributes.position;for(let r=0;r<e.points.length;r+=1){let i=e.points[r],a=Math.sin(Z.elapsed*1.15+r*.55+t)*.015;n.setXYZ(r,i.x,i.y+a,i.z)}n.needsUpdate=!0,e.line.material.opacity=.26+Z.glow*.1}),$.headGlow.rotation.z=-e,$.headGlow.material.opacity=.055+Z.glow*.035}function Ed(e){let t=hd.points.geometry.attributes.position.array,n=hd.points.geometry.attributes.color.array,r=hd.count;if(hd.spawnTimer-=e,hd.spawnTimer<=0){hd.spawnTimer=.035;let e=hd.cursor%r,n=Q.renderBones[Q.renderBones.length-1];hd.life[e]=1,t[e*3]=n.x,t[e*3+1]=n.y,t[e*3+2]=.1,hd.velocities[e].set(Dt.randFloat(-.45,.16),Dt.randFloatSpread(.36),0),hd.cursor+=1}for(let i=0;i<r;i+=1)hd.life[i]=Math.max(0,hd.life[i]-e*.64),t[i*3]+=hd.velocities[i].x*e,t[i*3+1]+=hd.velocities[i].y*e,od.copy(X.fire).lerp(X.gold,hd.life[i]*.75),n[i*3]=od.r*hd.life[i],n[i*3+1]=od.g*hd.life[i],n[i*3+2]=od.b*hd.life[i]*.7;hd.points.geometry.attributes.position.needsUpdate=!0,hd.points.geometry.attributes.color.needsUpdate=!0}function Dd(e){dd.group.position.lerp(nd,1-.02**e),dd.group.scale.setScalar(.92+Math.sin(Z.elapsed*5.2)*.05),dd.core.material.emissiveIntensity=1.4+Z.glow*.7+Math.sin(Z.elapsed*6.2)*.22,dd.aura.material.opacity=.13+Z.glow*.07+Math.sin(Z.elapsed*4.6)*.025,dd.light.intensity=(2.6+Z.glow*2.4)*(.85+Math.sin(Z.elapsed*5.8)*.08),dd.sparks.forEach((e,t)=>{let n=Z.elapsed*(1.3+t*.05)+t*1.9,r=.18+Math.sin(Z.elapsed*3+t)*.06;e.position.set(Math.cos(n)*r,Math.sin(n*1.22)*r,.05),e.scale.setScalar(.8+Math.sin(Z.elapsed*7+t)*.18)})}function Od(e){let t=Z.elapsed;md.points.rotation.z=Math.sin(t*.03)*.02;let n=md.points.geometry.attributes.position.array;for(let t=0;t<md.count;t+=1)n[t*3+1]+=e*md.speeds[t],n[t*3+1]>Z.viewHeight*.56&&(n[t*3+1]=-Z.viewHeight*.56,n[t*3]=Dt.randFloatSpread(Z.viewWidth*1.1));md.points.geometry.attributes.position.needsUpdate=!0,fd.forEach((e,n)=>{let r=Math.sin(t*.86+n*1.8)*.12;e.group.position.y=e.baseY+r,e.group.rotation.z=Math.sin(t*.55+n*1.2)*e.sway,e.glow.material.opacity=(.12+Math.sin(t*3.8+n)*.025)*Z.glow,e.sprite.material.uniforms.uGlow.value=Z.glow,e.sprite.material.uniforms.uTime.value=t+n,e.flame.intensity=(1.2+Math.sin(t*4.2+n)*.22)*Z.glow}),pd.forEach((n,r)=>{n.group.position.x+=e*n.speed,n.group.position.y=n.baseY+Math.sin(t*.24+r)*n.float,n.group.rotation.z=Math.sin(t*.16+r)*.025;let i=Z.viewWidth*.65;n.group.position.x>i&&(n.group.position.x=-i)})}function kd(e){_d-=e,_d<=0&&(Ad(),_d=1.4+Math.random()*1.7);for(let t=gd.length-1;t>=0;--t){let n=gd[t];n.age+=e;let r=n.age/n.life,i=n.geometry.attributes.position.array;for(let e=0;e<n.count;e+=1){let t=n.velocities[e];i[e*3]=t.x*n.age,i[e*3+1]=t.y*n.age-.32*n.age*n.age,i[e*3+2]=t.z*n.age}n.geometry.attributes.position.needsUpdate=!0,n.material.opacity=Math.max(0,(1-r)*.68)*Z.glow,n.points.scale.setScalar(1+r*.2),n.age>=n.life&&(ld.remove(n.points),n.geometry.dispose(),n.material.dispose(),gd.splice(t,1))}}function Ad(){let e=new Float32Array(174),t=new Dr;t.setAttribute(`position`,new fr(e,3));let n=[X.gold,X.fire,X.ember,X.paleGold],r=new _i({color:n[Math.floor(Math.random()*n.length)],size:.045,transparent:!0,opacity:.7,blending:2,depthWrite:!1}),i=new Si(t,r);i.position.set(Dt.randFloatSpread(Z.viewWidth*.72),Dt.randFloat(Z.viewHeight*.08,Z.viewHeight*.38),-2.4),ld.add(i);let a=Array.from({length:58},()=>{let e=Math.random()*Math.PI*2,t=Dt.randFloat(.25,1);return new U(Math.cos(e)*t,Math.sin(e)*t,Dt.randFloat(-.1,.1))});gd.push({points:i,geometry:t,material:r,velocities:a,count:58,age:0,life:1.1+Math.random()*.42})}function jd(){td.set(.62,.35),nd.set(Z.viewWidth*.2,Z.viewHeight*.06,.62),rd.copy(nd),Z.pointerActive=!1,Z.lastPointerAt=0;let e=-Z.viewWidth*.1,t=-Z.viewHeight*.02;Q.bones.forEach((n,r)=>{n.position.set(e-r*Z.segmentSpacing*.9,t+Math.sin(r*.55)*Z.segmentSpacing*.35,.2),n.previous.copy(n.position),n.velocity.set(0,0,0),Q.renderBones[r].copy(n.position)}),Vd()}function Md(e){Z.glow=e,$u.strength=.28+e*.42,$.bodyMaterials.forEach(t=>{t.uniforms.uGlow.value=e}),$.textureMaterials.forEach(t=>{t.uniforms.uGlow.value=e}),$.glowMaterials.forEach(t=>{t.userData.baseOpacity===void 0&&(t.userData.baseOpacity=t.opacity),t.opacity=t.userData.baseOpacity*(.78+e*.38)}),dd.core.material.emissiveIntensity=1.2+e*.8,dd.aura.material.opacity=.12+e*.08}function Nd(){let e=window.innerWidth,t=window.innerHeight,n=Math.min(window.devicePixelRatio||1,2),r=e/t,i=r<.75?9.8:8.8,a=i*r;Z.viewWidth=a,Z.viewHeight=i,Z.segmentSpacing=Dt.clamp(a/17.5,.22,.42),Z.bodyRadius=Z.segmentSpacing*.72,Zu.left=-a/2,Zu.right=a/2,Zu.top=i/2,Zu.bottom=-i/2,Zu.updateProjectionMatrix(),Yu.setPixelRatio(n),Yu.setSize(e,t,!1),Qu.setPixelRatio(n),Qu.setSize(e,t),$u.setSize(e,t),mf(),hf(),Bd()}function Pd(){new Ao().load(Ju(`assets/lantern/chinese-lantern.svg`),e=>{e.colorSpace=Le,e.anisotropy=Math.min(Yu.capabilities.getMaxAnisotropy(),8),fd.forEach(t=>{t.sprite.material.uniforms.uMap.value=e,t.sprite.material.uniforms.uReady.value=1,t.sprite.visible=!0,t.fallback.visible=!1}),Z.lanternLoaded=!0},void 0,()=>{Z.lanternLoaded=!1,fd.forEach(e=>{e.sprite.visible=!1,e.fallback.visible=!0})})}async function Fd(){if(Uu)try{let e=await fetch(Ju(`assets/reference-dragon/dragon-reference.html`));if(!e.ok)throw Error(`Reference dragon failed to load: ${e.status}`);let t=await e.text(),n=new DOMParser().parseFromString(t,`text/html`).querySelector(`svg defs`)?.cloneNode(!0);if(!n)throw Error(`Reference dragon SVG definitions were not found.`);Id(n);let r=document.createElementNS(qu,`g`);r.setAttribute(`id`,`referenceDragonScreen`),Uu.replaceChildren(n,r),sd.screen=r,sd.elems=Array.from({length:40},()=>({use:null,x:window.innerWidth/2,y:window.innerHeight*.45}));for(let e=sd.elems.length-1;e>=1;--e){let t=e===1?`Cabeza`:e===8?`AletasGreen`:e===14?`AletasPink`:`Espina`,n=document.createElementNS(qu,`use`);n.setAttribute(`href`,`#${t}`),n.setAttributeNS(`http://www.w3.org/1999/xlink`,`href`,`#${t}`),n.classList.add(`reference-dragon__piece`,`reference-dragon__piece--${t.toLowerCase()}`),t===`AletasGreen`?n.classList.add(`reference-dragon__wing`,`reference-dragon__wing--green`):t===`AletasPink`&&n.classList.add(`reference-dragon__wing`,`reference-dragon__wing--pink`),sd.elems[e].use=n,r.appendChild(n)}sd.ready=!0,Uu.classList.add(`is-ready`),ud.visible=!1,hd.points.visible=!1,Bd(),Vd()}catch(e){console.warn(e),sd.ready=!1,Uu.classList.remove(`is-ready`),ud.visible=!0,hd.points.visible=!0}}function Id(e){let t=e.querySelectorAll(`#Cabeza path`);t.forEach(e=>e.removeAttribute(`style`)),t[0]&&(t[0].setAttribute(`fill`,`#f7feff`),t[0].setAttribute(`fill-opacity`,`0.96`)),t[1]&&(t[1].setAttribute(`fill`,`#031827`),t[1].setAttribute(`fill-opacity`,`0.98`),t[1].setAttribute(`stroke`,`#00f7ff`),t[1].setAttribute(`stroke-width`,`0.95`),t[1].setAttribute(`stroke-opacity`,`0.86`)),Rd(e,`LinearGradID_1`,[`#f4ffff`,`#00f7ff`,`#003cff`]),Rd(e,`LinearGradID_2`,[`#ffffff`,`#14f7ff`,`#0815ff`]),Rd(e,`LinearGradID_3`,[`#e9ffff`,`#00b7ff`,`#5b00ff`]),zd(e,`WingGreenGrad`,[`#f2fff7`,`#33ff77`,`#00a84b`]),zd(e,`WingPinkGrad`,[`#fff5ff`,`#ff4fd8`,`#8d00ff`]),Ld(e,`AletasGreen`,`WingGreenGrad`,`#baffd1`,.98),Ld(e,`AletasPink`,`WingPinkGrad`,`#ffd5fb`,.98),e.querySelectorAll(`#Espina path`).forEach((e,t)=>{e.removeAttribute(`style`),e.setAttribute(`fill`,`url(#LinearGradID_${t===0?2:3})`),e.setAttribute(`fill-opacity`,`0.98`),e.setAttribute(`stroke`,t===0?`#ffffff`:`#00f7ff`),e.setAttribute(`stroke-width`,`0.28`),e.setAttribute(`stroke-opacity`,`0.46`)})}function Ld(e,t,n,r,i){let a=e.querySelector(`#Aletas`);if(!a)return;let o=a.cloneNode(!0);o.setAttribute(`id`,t);let s=o.querySelector(`path`);s&&(s.removeAttribute(`style`),s.setAttribute(`fill`,`url(#${n})`),s.setAttribute(`fill-opacity`,String(i)),s.setAttribute(`stroke`,r),s.setAttribute(`stroke-width`,`0.58`),s.setAttribute(`stroke-opacity`,`0.72`)),e.appendChild(o)}function Rd(e,t,n){let r=e.querySelector(`#${t}`);if(!r)return;let i=n.length===2?[`0`,`1`]:[`0`,`0.58`,`1`];r.replaceChildren(...n.map((e,t)=>{let r=document.createElementNS(qu,`stop`);return r.setAttribute(`offset`,i[t]),r.setAttribute(`stop-color`,e),r.setAttribute(`stop-opacity`,t===n.length-1?`0.94`:`1`),r}))}function zd(e,t,n){let r=document.createElementNS(qu,`linearGradient`);r.setAttribute(`id`,t),r.setAttribute(`gradientUnits`,`userSpaceOnUse`),r.setAttribute(`gradientTransform`,`matrix(0.0935974, 0, 0, 0.188782, -20.55, 0)`),r.setAttribute(`spreadMethod`,`pad`),r.setAttribute(`x1`,`-819.2`),r.setAttribute(`y1`,`0`),r.setAttribute(`x2`,`819.2`),r.setAttribute(`y2`,`0`),e.insertBefore(r,e.firstChild),Rd(e,t,n)}function Bd(){Uu&&Uu.setAttribute(`viewBox`,`0 0 ${window.innerWidth} ${window.innerHeight}`)}function Vd(){if(!sd.elems.length)return;let e=window.innerWidth*.48,t=window.innerHeight*.45;sd.orbit=0,sd.elems.forEach((n,r)=>{n.x=e-r*12,n.y=t+Math.sin(r*.5)*8})}function Hd(e){if(!sd.ready||!sd.elems[0])return;let t=window.innerWidth,n=window.innerHeight,r=sd.elems[0],i=Dt.clamp((nd.x/Z.viewWidth+.5)*t,28,t-28),a=Dt.clamp((.5-nd.y/Z.viewHeight)*n,36,n-86),o=!Z.pointerActive||performance.now()-Z.lastPointerAt>4200,s=Math.max(24,Math.min(t,n)*.16);sd.phase+=e*.72,sd.orbit=o?Math.min(sd.orbit+e*34,s):Math.max(sd.orbit-e*120,0);let c=Math.cos(sd.phase*3)*sd.orbit*(t/Math.max(n,1))*.38,l=Math.sin(sd.phase*4)*sd.orbit*(n/Math.max(t,1))*.38;r.x+=(i+c-r.x)*.13,r.y+=(a+l-r.y)*.13;let u=Dt.clamp(t/1500+.18,.42,.98),d=Dt.clamp(t/1500+.25,.48,1);for(let e=1;e<sd.elems.length;e+=1){let t=sd.elems[e],n=sd.elems[e-1],r=Math.atan2(t.y-n.y,t.x-n.x),i=Math.max(4,(104-e*1.45)*.2*d);if(t.x+=(n.x-t.x+Math.cos(r)*i)*.25,t.y+=(n.y-t.y+Math.sin(r)*i)*.25,!t.use)continue;let a=Math.max(.14,(162+4*(1-e))/50)*u,o=(n.x+t.x)/2,s=(n.y+t.y)/2;t.use.setAttribute(`transform`,`translate(${o.toFixed(2)},${s.toFixed(2)}) rotate(${(180/Math.PI*r).toFixed(2)}) scale(${a.toFixed(3)})`)}}function Ud(){return{bones:Array.from({length:22},(e,t)=>{let n=new U(-t*.34,Math.sin(t*.55)*.1,.2);return{position:n,previous:n.clone(),velocity:new U}}),renderBones:Array.from({length:22},(e,t)=>new U(-t*.34,0,.2))}}function Wd(e){let t=new Tn,n=[],r=[],i=[],a=[],o=[],s=[],c=new q(new ki(1,40),new Rr({color:0,transparent:!0,opacity:.16,depthWrite:!1}));c.renderOrder=0,t.add(c);let l=Gd(e,Kd());l.renderOrder=1,t.add(l);for(let r=e.bones.length-2;r>=0;--r){let e=qd(r),a=new q(new Ka(1,1,12,4),e);a.renderOrder=2,n.push(a),i.push(e),t.add(a)}n.reverse(),i.reverse();for(let n=2;n<e.bones.length-3;n+=1){let e=new Rr({color:X.gold,transparent:!0,opacity:.28,blending:2,depthWrite:!1}),n=new q(new ki(.05,14),e);r.push(n),s.push(e),t.add(n)}let u=[];for(let n=3;n<e.bones.length-4;n+=2){let e=Zd(n);e.mesh.renderOrder=5,u.push({...e,bone:n}),s.push(e.mesh.material),t.add(e.mesh)}let d=new Tn,f=Jd();d.add(f.group),f.glowMaterials.forEach(e=>s.push(e)),t.add(d);let p=f.details,m=f.whiskers,h=Qd();t.add(h);let g=[{group:$d(1,!0),bone:5,side:1,drop:1.18,scale:1.1,z:.6,speed:2.1,phase:.2},{group:$d(-1,!1),bone:9,side:-1,drop:1.04,scale:.98,z:.36,speed:1.9,phase:1.6},{group:$d(1,!0),bone:13,side:1,drop:1.12,scale:1.02,z:.58,speed:2,phase:2.8},{group:$d(-1,!1),bone:17,side:-1,drop:.98,scale:.88,z:.34,speed:1.8,phase:4.1}];return g.forEach(e=>t.add(e.group)),{group:t,bodyRibbon:l,bodySegments:n,bellySegments:r,bodyMaterials:i,textureMaterials:a,textureMeshes:o,glowMaterials:s,spines:u,claws:g,head:d,headSprite:null,headDetails:p,headGlow:f.glow,whiskers:m,tail:h,tailDetails:h.details,shadow:c,fallback:f.group}}function Gd(e,t){let n=e.bones.length,r=new Float32Array(n*2*3),i=new Float32Array(n*2*2),a=[];for(let e=0;e<n;e+=1){let t=e/Math.max(1,n-1),r=e*2;if(i[r*2]=t,i[r*2+1]=1,i[(r+1)*2]=t,i[(r+1)*2+1]=0,e<n-1){let e=r,t=r+1,n=r+2,i=r+3;a.push(e,t,n,n,t,i)}}let o=new Dr;o.setAttribute(`position`,new fr(r,3)),o.setAttribute(`uv`,new fr(i,2)),o.setIndex(a);let s=new q(o,t);return s.frustumCulled=!1,s}function Kd(){return new io({transparent:!0,depthWrite:!1,side:2,uniforms:{uTime:{value:0},uGlow:{value:Z.glow},uRed:{value:X.ember},uRuby:{value:X.ruby},uBlood:{value:X.blood},uGold:{value:X.gold},uFire:{value:X.fire}},vertexShader:`
      varying vec2 vUv;
      void main() {
        vUv = uv;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,fragmentShader:`
      ...
      void main() {
        float dorsal = smoothstep(0.54, 1.0, vUv.y);
        float belly = 1.0 - smoothstep(0.0, 0.48, vUv.y);
        float edge = smoothstep(0.0, 0.1, vUv.y) * (1.0 - smoothstep(0.9, 1.0, vUv.y));
        float scaleWave = sin(vUv.x * 118.0 + floor(vUv.y * 6.0) * 1.45 + uTime * 0.9);
        float scaleMarks = smoothstep(0.72, 1.0, scaleWave) * smoothstep(0.16, 0.92, vUv.y);
        float emberRun = sin(vUv.x * 18.0 - uTime * 2.4) * 0.5 + 0.5;

        vec3 color = mix(uRuby, uRed, 0.62);
        color = mix(color, uBlood, dorsal * 0.56);
        color = mix(color, uGold, belly * 0.44);
        color += uFire * emberRun * 0.08;
        color += uGold * scaleMarks * (0.16 + uGlow * 0.12);

        gl_FragColor = vec4(color, edge * 0.94);
      }
    `})}function qd(e){return new io({transparent:!0,depthWrite:!1,side:2,uniforms:{uTime:{value:0},uGlow:{value:Z.glow},uPhase:{value:e*.37},uRed:{value:X.ember},uRuby:{value:X.ruby},uGold:{value:X.gold},uFire:{value:X.fire}},vertexShader:`
      varying vec2 vUv;
      void main() {
        vUv = uv;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,fragmentShader:`
      ...
      float capsule(vec2 p) {
        p.x *= 1.16;
        vec2 q = vec2(abs(p.x) - 0.68, p.y * 0.88);
        return 1.0 - smoothstep(0.5, 0.58, length(vec2(max(q.x, 0.0), q.y)));
      }

      void main() {
        vec2 p = vUv * 2.0 - 1.0;
        float mask = capsule(p);
        if (mask < 0.02) discard;

        float belly = smoothstep(-0.12, -0.88, p.y);
        float dorsal = smoothstep(0.12, 0.9, p.y);
        float scaleRows = sin((vUv.x * 28.0) + uPhase + floor(vUv.y * 6.0) * 1.7);
        float scaleMarks = smoothstep(0.76, 1.0, scaleRows) * smoothstep(0.18, 0.95, mask);
        float shimmer = sin(uTime * 2.2 + vUv.x * 9.0 + uPhase) * 0.06;

        vec3 color = mix(uRuby, uRed, 0.64 + shimmer);
        color = mix(color, uGold, belly * 0.46);
        color = mix(color, uFire, dorsal * 0.24);
        color += uGold * scaleMarks * (0.22 + uGlow * 0.12);
        gl_FragColor = vec4(color, mask * 0.72);
      }
    `})}function Jd(){let e=new Tn,t=[],n=[],r=nf(X.fire,.08,!0),i=new q(new ki(.48,32),r);i.position.set(.16,.01,-.05),i.scale.set(1.35,.82,1),e.add(i),n.push(r);let a=tf([[-.5,-.19],[-.32,-.34],[.14,-.36],[.5,-.27],[.95,-.15],[1.12,.01],[.92,.16],[.58,.23],[.38,.37],[.02,.37],[-.32,.22],[-.5,.05]],nf(X.blood,.96));a.position.z=.08,e.add(a);let o=tf([[-.44,-.15],[-.25,-.29],[.18,-.29],[.48,-.2],[.9,-.09],[1.03,.02],[.82,.12],[.54,.18],[.32,.31],[.02,.3],[-.28,.18],[-.44,.03]],nf(X.ember,.96));o.position.z=.14,e.add(o);let s=tf([[.36,.04],[.76,.1],[1.08,.02],[.84,-.08],[.44,-.09]],nf(X.ruby,.92));s.position.z=.2,e.add(s);let c=tf([[.3,-.11],[.76,-.15],[.93,-.09],[.7,-.25],[.32,-.22]],nf(X.blood,.86));c.position.z=.18,e.add(c);let l=tf([[.08,.16],[.42,.23],[.68,.16],[.42,.09],[.08,.1]],nf(X.gold,.58,!0));l.position.z=.25,e.add(l);let u=tf([[-.04,-.06],[.24,-.13],[.38,-.03],[.18,.08]],nf(X.gold,.34,!0));u.position.z=.24,e.add(u);let d=new q(new ki(.032,18),nf(X.paleGold,.9,!0));d.position.set(.46,.12,.3),e.add(d);let f=new q(new ki(.012,12),nf(X.blood,.92));f.position.set(.47,.12,.32),e.add(f);let p=new q(new ki(.014,10),nf(X.blood,.9));p.position.set(.86,-.005,.3),p.scale.set(1.4,.8,1),e.add(p);let m=nf(X.paleGold,.76);[.52,.68,.83].forEach((t,n)=>{let r=tf([[0,0],[.035,-.105-n*.004],[.07,0]],m.clone());r.position.set(t,-.075,.29),r.rotation.z=n*.045,e.add(r)});let h=nf(X.gold,.66,!0);[{x:.1,y:.28,r:-.1,length:.46},{x:-.12,y:.24,r:-.3,length:.36}].forEach(t=>{let n=tf([[0,0],[.08,.02],[t.length,.42],[.02,.12]],h.clone());n.position.set(t.x,t.y,.24),n.rotation.z=t.r,e.add(n)}),Yd().forEach(t=>e.add(t)),[{x:-.26,y:.2,r:.72,sx:.08,sy:.34,c:X.fire,o:.28},{x:.08,y:-.25,r:-2.2,sx:.07,sy:.32,c:X.gold,o:.3}].forEach((n,r)=>{let i=new q(new ji(.2,1,3),nf(n.c,n.o,!0));i.position.set(n.x,n.y,.29+r*.01),i.rotation.z=n.r,i.scale.set(n.sx,n.sy,1),i.baseOpacity=i.material.opacity,i.baseRotation=n.r,i.speed=1.1+r*.18,i.swing=.025+r*.006,t.push(i),e.add(i)});let g=Xd();return g.forEach(t=>e.add(t.line)),{group:e,details:t,whiskers:g,glowMaterials:n,glow:i}}function Yd(){let e=new si({color:X.paleGold,transparent:!0,opacity:.34,blending:2,depthWrite:!1});return[[new U(.16,.42,.33),new U(.32,.58,.33),new U(.52,.63,.33)],[new U(-.08,.36,.32),new U(-.22,.52,.32),new U(-.12,.64,.32)]].map(t=>new hi(new Dr().setFromPoints(t),e.clone()))}function Xd(){let e=new si({color:X.paleGold,transparent:!0,opacity:.3,blending:2,depthWrite:!1});return[[new U(.58,.04,.34),new U(.98,.22,.34),new U(1.36,.12,.34)],[new U(.56,-.08,.34),new U(.98,-.26,.34),new U(1.32,-.12,.34)]].map(t=>{let n=new Vi(t).getPoints(32);return{line:new hi(new Dr().setFromPoints(n),e.clone()),points:n}})}function Zd(e){let t=e/22;return{mesh:tf([[-.18,0],[-.05,.16],[.03,.72],[.16,.18],[.2,0],[0,.05]],nf(e%4==1?X.gold:X.fire,.48,!0)),phase:e*.63,speed:2.1+e%3*.2,swing:.045+t*.025,lift:.14,width:1-t*.22,height:2.15-t*.62,opacity:.42+e%3*.04}}function Qd(){let e=new Tn,t=[],n=tf([[-.1,.14],[.36,.1],[.78,.02],[1.02,0],[.72,-.08],[.28,-.13],[-.1,-.12]],nf(X.ember,.9));return n.position.z=.1,e.add(n),[{y:0,r:1.55,sx:.18,sy:.82,c:X.gold,o:.7},{y:.09,r:1.3,sx:.14,sy:.68,c:X.fire,o:.48},{y:-.09,r:1.85,sx:.14,sy:.66,c:X.fire,o:.48},{y:.02,r:1.62,sx:.08,sy:1.08,c:X.paleGold,o:.52}].forEach((n,r)=>{let i=new q(new ji(.28,1,3),nf(n.c,n.o,!0));i.position.set(.82+r*.06,n.y,.18+r*.02),i.rotation.z=n.r,i.scale.set(n.sx,n.sy,1),i.baseOpacity=i.material.opacity,i.baseRotation=n.r,i.speed=3.2+r*.45,i.swing=.12+r*.02,t.push(i),e.add(i)}),e.details=t,e}function $d(e,t=!0){let n=new Tn,r=t?.9:.48,i=nf(t?X.ember:X.ruby,r),a=nf(X.gold,t?.68:.32,!0),o=nf(X.paleGold,t?.95:.52,!0),s=new H(-.14*e,-.32),c=new H(.12*e,-.66),l=ef(new H(0,0),s,.07,.045,i),u=ef(s,c,.052,.038,i.clone());n.add(l,u);let d=ef(new H(.02*e,-.04),new H(-.08*e,-.28),.018,.012,a);d.position.z=.04,n.add(d);let f=new q(new ki(.055,14),a.clone());return f.position.set(c.x,c.y,.06),n.add(f),[-1,0,1].forEach(t=>{let r=tf([[0,0],[.18*e,-.04],[.04*e,.08]],o.clone());r.position.set(c.x+t*.06,c.y-Math.abs(t)*.025,.08),r.rotation.z=-.18*t+e*.22,n.add(r)}),n.traverse(e=>{e.material&&(e.material.userData.baseOpacity=e.material.opacity)}),n}function ef(e,t,n,r,i){let a=new H().subVectors(t,e),o=new H(-a.y,a.x).normalize();return tf([[e.x+o.x*n,e.y+o.y*n],[t.x+o.x*r,t.y+o.y*r],[t.x-o.x*r,t.y-o.y*r],[e.x-o.x*n,e.y-o.y*n]],i)}function tf(e,t){let n=new ca;return n.moveTo(e[0][0],e[0][1]),e.slice(1).forEach(([e,t])=>n.lineTo(e,t)),n.closePath(),new q(new qa(n),t)}function nf(e,t=1,n=!1){let r=new Rr({color:e,transparent:t<1||n,opacity:t,blending:n?2:1,depthWrite:!1,side:2});return r.userData.baseOpacity=t,r}function rf(){let e=new Tn,t=new q(new Ya(.1,24,16),new oo({color:X.paleGold,emissive:X.fire,emissiveIntensity:1.8,roughness:.16,metalness:.1})),n=new q(new Ya(.34,24,16),new Rr({color:X.fire,transparent:!0,opacity:.18,blending:2,depthWrite:!1})),r=new Go(16751942,4.2,6),i=new Rr({color:X.gold,transparent:!0,opacity:.74,blending:2,depthWrite:!1}),a=[];e.add(n,t,r);for(let t=0;t<8;t+=1){let t=new q(new Ya(.02,8,6),i.clone());a.push(t),e.add(t)}return{group:e,core:t,aura:n,light:r,sparks:a}}function af(){let e=new Float32Array(390),t=new Float32Array(390),n=new Dr;return n.setAttribute(`position`,new fr(e,3)),n.setAttribute(`color`,new fr(t,3)),{points:new Si(n,new _i({size:.045,vertexColors:!0,transparent:!0,opacity:.72,blending:2,depthWrite:!1})),velocities:Array.from({length:130},()=>new U),life:new Float32Array(130),count:130,cursor:0,spawnTimer:0}}function of(){return Array.from({length:8},(e,t)=>{let n=new Tn,r=new Rr({color:X.paleGold,transparent:!0,opacity:.5,depthWrite:!1}),i=sf(),a=new Rr({color:X.fire,transparent:!0,opacity:.22,blending:2,depthWrite:!1}),o=new q(new Ai(.006,.006,1.08,6),r);o.position.y=.78;let s=new q(new ki(.46,28),a);s.position.set(0,-.1,-.04),s.scale.set(.82,1.38,1);let c=new q(new Ka(.48,1.5),i);c.position.set(0,-.18,.02),c.visible=!1;let l=cf(),u=lf(),d=new Go(16747323,1.2,4);return d.position.y=-.08,n.add(o,s,u,c,l,d),n.scale.setScalar(.7+t%3*.08),{group:n,sprite:c,fallback:u,glow:s,flame:d,baseY:0,offset:t/7,sway:.035+t%3*.012}})}function sf(){return new io({transparent:!0,depthWrite:!1,side:2,uniforms:{uMap:{value:null},uReady:{value:0},uGlow:{value:Z.glow},uTime:{value:0},uRuby:{value:X.ruby},uRed:{value:X.ember},uGold:{value:X.gold},uPale:{value:X.paleGold}},vertexShader:`
      varying vec2 vUv;
      void main() {
        vUv = uv;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,fragmentShader:`
      ...
      void main() {
        ...
        float center = 1.0 - smoothstep(0.0, 0.42, abs(vUv.x - 0.5));
        float band = smoothstep(0.88, 0.96, vUv.y) + (1.0 - smoothstep(0.04, 0.14, vUv.y));
        float ribs = pow(abs(sin((vUv.x - 0.5) * 18.0)), 5.0) * smoothstep(0.12, 0.82, vUv.y);
        float flicker = sin(uTime * 4.0 + vUv.y * 9.0) * 0.04;

        vec3 color = mix(uRuby, uRed, 0.82 + center * 0.1 + flicker);
        color = mix(color, uGold, clamp(band * 0.62 + ribs * 0.2 + luma * 0.12, 0.0, 0.72));
        color = color * (1.46 + uGlow * 0.22) + uPale * center * (0.1 + uGlow * 0.1);

        gl_FragColor = vec4(color, tex.a * 0.96);
      }
    `})}function cf(){let e=new Tn,t=new Rr({color:X.gold,transparent:!0,opacity:.82,blending:2,depthWrite:!1}),n=new Rr({color:X.ruby,transparent:!0,opacity:.55,depthWrite:!1}),r=new q(new Oi(.34,.055,.02),t);r.position.set(0,.3,.08);let i=new q(new Oi(.42,.035,.02),t.clone());i.position.set(0,.25,.08);let a=new q(new Oi(.36,.05,.02),t.clone());a.position.set(0,-.47,.08);let o=new q(new ji(.09,.28,4),t.clone());o.position.set(0,-.66,.08),o.rotation.x=Math.PI;let s=new q(new Ka(.5,.045),n);return s.position.set(0,-.08,.07),e.add(s,r,i,a,o),e}function lf(){let e=new Tn,t=new oo({color:X.ember,emissive:X.ruby,emissiveIntensity:.5,roughness:.36,metalness:.14}),n=new oo({color:X.gold,emissive:X.gold,emissiveIntensity:.32,roughness:.26,metalness:.42}),r=new q(new Ya(.25,22,14),t);r.scale.set(.82,1.08,.82);let i=new q(new Ai(.14,.17,.06,22),n);i.position.y=.28;let a=i.clone();a.position.y=-.28;let o=new q(new ji(.07,.24,12),n);return o.position.y=-.48,o.rotation.x=Math.PI,e.add(r,i,a,o),e}function uf(){let e=[new si({color:X.smoke,transparent:!0,opacity:.16,blending:2,depthWrite:!1}),new si({color:X.gold,transparent:!0,opacity:.11,blending:2,depthWrite:!1}),new si({color:X.ruby,transparent:!0,opacity:.13,blending:2,depthWrite:!1})];return Array.from({length:12},(t,n)=>{let r=new Tn,i=2+n%3;for(let t=0;t<i;t+=1){let i=[],a=1.35+n*.06+t*.36,o=.06+t*.035,s=n*.6+t*1.8;for(let e=0;e<36;e+=1){let t=e/35;i.push(new U((t-.5)*a,Math.sin(t*Math.PI*2.1+s)*o+Math.sin(t*Math.PI*5.4+s)*o*.28,-3.6))}let c=new hi(new Dr().setFromPoints(i),e[(n+t)%e.length].clone());c.position.y=t*.06,r.add(c)}return r.position.z=-3.6-n*.05,{group:r,baseY:0,float:.06+n%4*.025,speed:.016+n*.004}})}function df(){let e=new Float32Array(360*3),t=new Float32Array(360*3),n=new Float32Array(360),r=new Dr;for(let r=0;r<360;r+=1)e[r*3]=Dt.randFloatSpread(30),e[r*3+1]=Dt.randFloatSpread(14),e[r*3+2]=Dt.randFloat(-5,-1.6),od.copy(Math.random()>.18?X.gold:X.fire),od.multiplyScalar(.5+Math.random()*.6),t[r*3]=od.r,t[r*3+1]=od.g,t[r*3+2]=od.b,n[r]=.05+Math.random()*.22;return r.setAttribute(`position`,new fr(e,3)),r.setAttribute(`color`,new fr(t,3)),{points:new Si(r,new _i({size:.027,vertexColors:!0,transparent:!0,opacity:.72,blending:2,depthWrite:!1})),count:360,speeds:n}}function ff(e,t,n,r){let i=id.copy(t).lerp(n,.5),a=Math.max(t.distanceTo(n),.001);e.position.copy(i),e.position.z=r.z||.2,e.rotation.z=Math.atan2(t.y-n.y,t.x-n.x),e.scale.set(a*r.width,r.height,1)}function pf(){let e=new U;return Q.renderBones.forEach(t=>e.add(t)),e.multiplyScalar(1/Q.renderBones.length)}function mf(){let e=Z.viewHeight*.42,t=Z.viewWidth*.82;fd.forEach((n,r)=>{let i=r%2==0?0:-.34;n.group.position.set(-t/2+n.offset*t,e+i,-1.1-r*.04),n.baseY=n.group.position.y})}function hf(){pd.forEach((e,t)=>{let n=t/Math.max(1,pd.length-1);e.group.position.x=-Z.viewWidth*.58+n*Z.viewWidth*1.16,e.group.position.y=Z.viewHeight*(-.28+t%4*.12),e.baseY=e.group.position.y})}